...
class SalesMonthlyReportExport implements FromCollection,ShouldAutoSize,WithHeadings
{
    ...
    public function headings(): array
    {
        return [
            ...
            'Gatepass Status',
            'Survey Type',
            'Q. 4 I am making an after sale call regarding your experience when you came to purchase a vehicle from us. On a scale of 0-10 (0=Very Unlikely, 10=Very Likely) - How likely is it that you would recommend Toyota Kenya to family, friends, colleagues?',
            'Q. 5 Please tell us why you gave this score?',
            'Category (NPS VOC)',
            'Q. 6 Did you feel that the Sales Consultant explained the products, its features and functionality to you BEFORE purchase?	',
            'Q. 7 Did the Sales Consultant who delivered your vehicle book your 1000km free service & call to remind you?	',
            'Q. 8 Did the Sales Consultant brief you about the BOOK OF LIFE, including Warranty and Maintenance?',
            'Q. 9 Did your Sales Advisor make a courtesy call to you after collection of your vehicle to confirm your satisfaction?',
            'VOC Comment',
            'Type',
            'Department',
            'Comment Summary',
    ...
    */
    public function collection()
    {
        ...
        foreach($records as $record){
            ...
            array_push($singleRecord, isset($record->contact->created_by) ? isset(\App\Models\User::query()->firstWhere('pf_no',$record->contact->created_by)->name)? \App\Models\User::query()->firstWhere('pf_no',$record->contact->created_by)->name :'' : '');
            ...
            array_push($singleRecord, isset($q[9]) ? $q[9] : '');
