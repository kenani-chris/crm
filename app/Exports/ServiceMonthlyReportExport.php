...
class ServiceMonthlyReportExport implements FromCollection,ShouldAutoSize,WithHeadings
{   
    ...
    */
    public function collection()
    {
        ...
        foreach($records as $record){
            ...
            array_push($singleRecord, (isset($record->contact->created_by) && isset(\App\Models\User::where('pf_no',$record->contact->created_by)->first()->name)) ? \App\Models\User::where('pf_no',$record->contact->created_by)->first()->name : '');
            ...
            array_push($singleRecord, isset($q[10]) ? $q[10] : '');
