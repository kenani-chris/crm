...
class VOCReportExport implements FromCollection,ShouldAutoSize,WithHeadings
{
    ...
    public function collection()
    {
        ...
        $records=ToyotaCase::with([
            ...
            foreach ($records as  $singleRecordComplete) {
                ...
                array_push($singleRecord, date('Y-m-d',strtotime($singleRecordComplete->created_at)));
