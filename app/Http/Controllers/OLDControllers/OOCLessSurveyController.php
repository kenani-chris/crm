...
class OOCLessSurveyController extends Controller
{
    ...
    public function intro(Request $request, $id){
        ...
        $customer=OOCLess::where('id',$id)->first();
    ...
    public function introQuestion($question, $id){
        ...
        return view('outbound.oocless.questions.'.$question,['channel'=>$channel,'customer'=>$customer]);
    ...
    public function surveyQuestions(Request $request, $question, $id){
        ...
        $getLastSurvey=OOCLessSurvey::where('lead_id',$id)->orderBy('created_at', 'DESC')->first();
   ...
   */
    public function saveStart($intro, $lead_id){
        ...
        $checkDuplicate=OOCLessSurvey::where('lead_id', $lead_id)->whereNull('disposition')->orderBy('created_at','DESC')->get(['id','lastQuestion']);
      ...
      //  dd($checkDuplicate[0]->lastQuestion);
        ...
        $channel="OOC Less than 50% Channel";
        $customer=OOCLess::where('id',$lead_id)->first();
        if($checkDuplicate[0]->lastQuestion=='intro'){

        }else{
        return view('outbound.oocless.questions.'.$checkDuplicate[0]->lastQuestion,['channel'=>$channel,'customer'=>$customer]);
        }
    }
     ...
     */
     ...
     public function getIntro(){
        ...
        return view('outbound.oocless.index',['channel'=> $channel,'customer'=>$customer]);
    }
    ...
    public function changeLeadDisposition($lead_id, $disposition){
        ...
        $lead=OOCLess::where('id',$lead_id)->update(array(
    ...
    public function saveSurvey($payload,$survey_id){
        ...
        $oocgreater=OOCLessSurvey::where('id',$survey_id)->whereNotNull('intro')->update($payload);
