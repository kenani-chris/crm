...
!(function(e, t) {
    ...
    var f = function() {},
        ...
        g = {
            ...
            K: function(e, t, n) {
                e.setHours(
                    (e.getHours() % 12) +
                        12 * o(new RegExp(n.amPM[1], "i").test(t))
                );
            },
            M: function(e, t, n) {
    ...
    function y(f, g) {
                    ...
                    window.requestAnimationFrame(function() {
                        if (
                            (void 0 !== h.calendarContainer &&
                                ((h.calendarContainer.style.visibility =
                                    "hidden"),
                            ...
                            (h.daysContainer.style.width = t + "px"),
                                (h.calendarContainer.style.width =
                                    ...
                                    (void 0 !== h.weekWrapper
                                        ...
                                        : 0) +
                                    "px"),
                                h.calendarContainer.style.removeProperty(
                                    "visibility"
                                ),
                                h.calendarContainer.style.removeProperty(
                                    "display"
                ...
                void 0 !== e &&
                    ...
                    (function(e) {
                        ...
                        void 0 !== h.amPM &&
                            ...
                            (h.amPM.textContent =
                                h.l10n.amPM[
                                    o(h.amPM.textContent === h.l10n.amPM[0])
                                ]);
                      ...
                      he(t) &&
                          ...
                          "range" === h.config.mode &&
                              (c(
                                  ...
                                  "startRange",
                                  h.selectedDates[0] &&
                                      0 === w(t, h.selectedDates[0], !0)
                              ),
                              c(
                                  o,
                                  "endRange",
                                  h.selectedDates[1] &&
                                      0 === w(t, h.selectedDates[1], !0)
                              ),
                              "nextMonthDay" === e &&
        ...
        function K() {
            if (
                !(
                    ...
                    "dropdown" !== h.config.monthSelectorType
                )
            ) {
                var e = function(e) {
                    return (
                ...
                for (var t = 0; t < 12; t++)
                    if (e(t)) {
                        ...
                        (n.value = new Date(h.currentYear, t)
                            .getMonth()
                            .toString()),
                            (n.textContent = m(
                                t,
                                h.config.shorthandCurrentMonth,
                                h.l10n
                            )),
                            (n.tabIndex = -1),
            ...
            if (h.isOpen && !h.config.inline) {
                var t =
                    ...
                    a =
                        ...
                        (e.path &&
                            e.path.indexOf &&
                            (~e.path.indexOf(h.input) ||
                                ~e.path.indexOf(h.altInput))),
                    i =
                        "blur" === e.type
            ...
            if (
                ...
                for (
                    var t = e
                        ...
                        n = h
                            .parseDate(h.selectedDates[0], void 0, !0)
                            .getTime(),
        ...
        function re() {
            "object" != typeof h.config.locale &&
                ...
                (p.K =
                    ...
                    ")"),
                void 0 ===
                    e({}, g, JSON.parse(JSON.stringify(f.dataset || {})))
                        .time_24hr &&
        ...
        function le(e) {
            if (void 0 !== h.calendarContainer) {
                ...
                if (
                    ...
                    if (
                        (c(h.calendarContainer, "rightMost", g),
                        !h.config.static)
                    )
                        if (((h.calendarContainer.style.top = u + "px"), g))
                            if (p) {
                                ...
                                (h.calendarContainer.style.left = "auto"),
                                    (h.calendarContainer.style.right =
                                        m + "px");
                        else
        ...
        function se(e) {
            ...
            if (void 0 !== t) {
                var n = t,
                    a = (h.latestSelectedDateObj = new Date(
                        n.dateObj.getTime()
                    )),
                    i =
                        (a.getMonth() < h.currentMonth ||
                            a.getMonth() >
                                h.currentMonth + h.config.showMonths - 1) &&
                        "range" !== h.config.mode;
            ...
            (h.destroy = function() {
                ...
                if (((h._handlers = []), h.mobileInput))
                    ...
                    if (h.config.static && h.calendarContainer.parentNode) {
                        ...
                        h.calendarContainer.parentNode.removeChild(
                            h.calendarContainer
                        );
                h.altInput &&
                    ((h.input.type = "text"),
        ...
        function ve() {
            h.config.noCalendar ||
                ...
                (h.yearElements.forEach(function(e, t) {
                    ...
                    n.setMonth(h.currentMonth + t),
                        h.config.showMonths > 1 ||
                        "static" === h.config.monthSelectorType
                            ...
                            : (h.monthsDropdownContainer.value = n
                                  .getMonth()
                                  .toString()),
        ...
        function we(e) {
            void 0 === e && (e = !0),
                ...
                void 0 !== h.altInput &&
                    (h.altInput.value = De(h.config.altFormat)),
                ...
                (h.element = h.input = f),
                    ...
                    h.input
                        ? ((h.input._type = h.input.type),
                          ...
                          (h._positionElement =
                              h.config.positionElement || h._input))
                        : h.config.errorHandler(
                        ...
                        e && fe(e, h.config.dateFormat),
                            (h._initialDate =
                                h.selectedDates.length > 0
                                    ? h.selectedDates[0]
                                    : h.config.minDate &&
                                      h.config.minDate.getTime() >
                                          h.now.getTime()
                                    ? h.config.minDate
                                    : h.config.maxDate &&
                                      h.config.maxDate.getTime() <
                                          h.now.getTime()
                                    ? h.config.maxDate
                                    : h.now),
                            (h.currentYear = h._initialDate.getFullYear()),
                            ...
                            void 0 !== h.config.minTime &&
                                (h.config.minTime = h.parseDate(
                                    h.config.minTime,
                                    "H:i"
                                )),
                            void 0 !== h.config.maxTime &&
                                (h.config.maxTime = h.parseDate(
                                    h.config.maxTime,
                                    "H:i"
                                )),
                            (h.minDateHasTime =
                            ...
                            if (
                                ...
                                if (
                                    (e.appendChild(
                                        ...
                                        (h.prevMonthNav.innerHTML =
                                            h.config.prevArrow),
                                        (h.nextMonthNav = d(
                                            "span",
                                            "flatpickr-next-month"
                                        )),
                                        (h.nextMonthNav.innerHTML =
                                            h.config.nextArrow),
                                        q(),
                                ...
                                e.appendChild(
                                    (function() {
                                        ...
                                        var e = d(
                                            ...
                                            t = u("flatpickr-hour", {
                                                "aria-label":
                                                    h.l10n.hourAriaLabel
                                            });
                                        h.hourElement = t.getElementsByTagName(
                                            "input"
                                        )[0];
                        ...
                        if (
                            ...
                            (h._debouncedChange = r(Y, M)),
                                h.daysContainer &&
                                    ...
                                    F(h.daysContainer, "mouseover", function(
                                        e
                                    ) {
                                        "range" === h.config.mode &&
                                            ne(e.target);
