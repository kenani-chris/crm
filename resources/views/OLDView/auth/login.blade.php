...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Log In | DT DOBIE CRM</title>
        ...
        <div class="auth-fluid">
                        ...
                        <div class="auth-brand text-center text-lg-left">
                            <div class="auth-logo">
                                <a href="#" class="logo logo-dark text-center">
                                    <span class="logo-lg">
                                        <img src="{{asset('assets/images/logo.png')}}" alt="DT DOBIE" height="70">
                                    </span>
                                </a>
            ...
            <div class="auth-fluid-right text-center">
                <div class="auth-user-testimonial">
                    <h2 class="mb-3 text-white">DT DOBIE Call Center CRM</h2>
                    <p class="lead"><i class="mdi mdi-format-quote-open"></i>Just having satisfied customers isn’t good enough anymore. If you really want a booming business, you have to create raving fans.  <i class="mdi mdi-format-quote-close"></i>
                    </p>
