...
$(document).ready(function(){
    ...
    var paymentTable=$('#todayPayment').DataTable({
         ...
         ajax:{
             ...
             data:function(d){
                 d.channel="1";
                 /*d.brand_source=$('input[name=brand_source]').val();
                 d.brand_name=$('input[name=brand_name]').val();
                 d.brand_token=$('input[name=brand_token]').val();
                 d.date_from=$('input[name=date_from]').val();
                 d.date_to=$('input[name=date_to]').val();
                 d.cat_status = $('select[name=cat_status]').val();
                 d.myanalyst = $('select[name=analyst]').val();
                 d.activation_status=$('select[name=activation_status]').val();
                 d.no_activation_status=$('select[name=no_activation_status]').val();
