...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <form action="{{route('question.oocless',['q4',$customer->id])}}" id="survey1" method="post" enctype="multipart/form-data">
            @csrf
...
$('.q3Activate').click(function() { 

var activationValue =$("input[name='q3']:checked").val(); 


//$(".notactivatedres").prop("checked", false);
$('#q3_date').val('');
$('#q3_time').val('');
if(activationValue ==='Today'){
    $(".q3_time").css("display", "block");
    $(".q3_date").css("display", "none");
}else if(activationValue ==='Later'){
    $(".q3_date").css("display", "block");
    $(".q3_time").css("display", "none");
}else{
