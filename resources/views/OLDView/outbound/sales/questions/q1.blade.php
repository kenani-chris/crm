...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <form action="{{route('question.'.$slug,['q2',$customer->id])}}" id="survey1" method="post" enctype="multipart/form-data">
            @csrf
                                        ...
                                        <ul>
                                            ...
                                            @endforeach
                                                            ...
                                                            <?php
                                                                ...
                                                                ?>, My name is <b>{{Auth::user()->name}}</b> and I'm calling you from DT DOBIE <b>{{$customer->RetailOutletDealerCode}}</b>. I'm I speaking to <b>{{$customer->Title.' '.$customer->Initials.' '.$customer->Surname}}</b>?</p>
