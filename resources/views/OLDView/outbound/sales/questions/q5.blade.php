...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <form action="{{route('question.'.$slug,['q6',$customer->id])}}" id="survey1" method="post" enctype="multipart/form-data">
            @csrf
                                        ...
                                        <ul>
                                            ...
                                            @endforeach
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input oleSummary" type="radio" name="q5_comment_type_id" id="{{$comment_type->id}}" value="{{$comment_type->id}}" required>
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('q5_comment_type_id') }}</span>
                                                        </div>
                                                        ...
                                                        <p>Department</p>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input oleSummary" type="radio" name="q5_channel_id" id="{{$comment_type->id}}" value="{{$channel->id}}" required>
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('q5_channel_id') }}</span>
                                                    ...
                                                    <select class="form-control" required  name="q5_comment_summary_id" id="comment_summary">
                                                        ...
                                                        <span class="text-danger">{{ $errors->first('q5_comment_summary_id') }}</span>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="q5_action_required" id="q5_action_required_a" value="Yes" required>
                                                                <label class="form-check-label" for="q5_action_required_a">Yes</label>
                                                                </div>

                                                                <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="q5_action_required" id="q5_action_required_b" value="No" required>
                                                                <label class="form-check-label" for="q5_action_required_b">No</label>
                                                                </div>
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('q5_action_required') }}</span>
...
$('.oleSummary').click(function() {
    ...
    var comment_type=$("input[name='q5_comment_type_id']:checked").val(); 
    var department=$("input[name='q5_channel_id']:checked").val();
