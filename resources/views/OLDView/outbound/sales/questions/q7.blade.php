...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <form action="{{route('question.'.$slug,['q8',$customer->id])}}" id="survey1" method="post" enctype="multipart/form-data">
            @csrf
                                        ...
                                        <ul>
                                            ...
                                            @endforeach
                                                            ...
                                                            <p>Q7. Was you vehicle delivered in perfect condition?   </p>
                                                           
                                                           
                                                            <div class="custom-control custom-radio custom-control-inline ">
                                                            <input type="radio" id="q7" required value="Yes" name="q7" class="custom-control-input missingOle">
                                                            <label class="custom-control-label" for="q7">Yes</label>
                                                           
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" required id="q7b" value="No" name="q7" class="custom-control-input missingOle">
                                                                <label class="custom-control-label" for="q7b">No</label>
