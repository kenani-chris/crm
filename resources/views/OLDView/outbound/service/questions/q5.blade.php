            ...
            @csrf
                                        ...
                                        <ul>
                                            ...
                                            @endforeach
                                                            ...
                                                            <p>Q5. Did the service advisor offer to inspect your vehicle with you before the works started?   </p>
                                                           
                                                            <div class="custom-control custom-radio custom-control-inline ">
                                                            <input type="radio" id="q5" required value="Yes" name="q5" class="custom-control-input missingOle">
                                                            <label class="custom-control-label" for="q5">Yes</label>
                                                           
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" required id="q5b" value="No" name="q5" class="custom-control-input missingOle">
                                                                <label class="custom-control-label" for="q5b">No</label>
