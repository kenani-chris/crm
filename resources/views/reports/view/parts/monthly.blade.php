...
<table id="monthlyReports" class="table table-centered table-nowrap table-striped table-bordered " style='border-collapse: collapse;'>
    <button id="parts-report-monthly" class="btn btn-primary btn-sm position-absolute export-btns"><span class="mdi mdi-microsoft-excel"></span> Export to Excel </button>
<thead>
...
<th>Service Advisor</th>
                ...
                <th>Survey Type</th>
                <th>Q. 4 I am making a follow up to get your satisfaction with regards to your experience when you came to purchase parts from us. On a scale of 0-10 (0=Very Unlikely, 10=Very Likely) - How likely is it that you would recommend Toyota Kenya to family, friends, colleagues?</th>	
<th>Q. 5 Please tell us why you gave this score?	</th>
<th>Category (NPS VOC)	</th>
<th>Q. 6 Were you satisfied with the process from documentation up to supply of parts?	</th>
<th>Q. 7 Were the correct parts supplied?	</th>
<th>Q. 8 Did we have all the parts you required?	</th>
                <th>VOC Comment</th>
                <th>Type</th>
                <th>Department</th>
...
/*########################### Export Logic ##################################*/
$('#parts-report-monthly').css('display','block');
$('#parts-report-monthly').click(function(){
    $('#search-form').attr('action',"{{route('reports.parts.monthly.export',request()->id)}}");
    $('#search-form').submit();
});
/*###########################################################################*/
