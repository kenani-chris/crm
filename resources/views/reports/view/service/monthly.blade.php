...
<div class="table-responsive">
                ...
                <table id="monthlyReports" class="table table-centered table-nowrap table-striped table-bordered " style='border-collapse: collapse;'>
                    <button id="service-report-monthly" class="btn btn-primary btn-sm position-absolute export-btns" style="right: 280px !important;"><span class="mdi mdi-microsoft-excel"></span> Export to Excel </button>
                <thead>
                
                <tr>
                <th>#</th>
                <th>Date of Vehicle Delivery</th>	
                <th>Customer Name</th>	
                <th>Company Name</th>	
                <th>Customer Tel.</th>	
...
/*########################### Export Logic ##################################*/
$('#service-report-monthly').css('display','block');
$('#service-report-monthly').click(function(){
    $('#search-form').attr('action',"{{route('reports.service.monthly.export',request()->id)}}");
    $('#search-form').submit();
});
/*###########################################################################*/
